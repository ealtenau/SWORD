...
nc_fn = main_dir+'/data/outputs/Reaches_Nodes/'+version+\
    '/netcdf/'+region.lower()+'_sword_'+version+'.nc'
csv_dir1 = main_dir+'/data/update_requests/'+version+'/'+region+\
    '/'+region.lower()+'_node_order_problems.csv'
csv_dir2 = main_dir+'/data/update_requests/'+version+'/'+region+\
