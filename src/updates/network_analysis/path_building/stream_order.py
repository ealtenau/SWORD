...
version = 'v17'
basin = 'hb52'
path_nc = main_dir+'/data/outputs/Reaches_Nodes/'+version+'/network_building/pathway_netcdfs/'+region+'/'+basin+'_path_vars.nc'
con_dir = main_dir+'/data/outputs/Reaches_Nodes/'+version+'/reach_geometry/'+region.lower()+'_sword_'+version+'_connectivity.nc'
