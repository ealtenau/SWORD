...
data_dir = main_dir+'/data/outputs/'
fn1 = data_dir+'Topology/'+region+'/b'+basin+'/'+region.lower()+'_sword_reaches_hb'+basin+'_'+version+'_FG1_pts.shp'
fn2 = data_dir+'Reaches_Nodes/'+version+'/reach_geometry/'+region.lower()+'_sword_'+version+'_connectivity.nc'
fn3 = data_dir+'Topology/'+region+'/b'+basin+'/intermediate/prob_rchs_all.csv'
outfile = data_dir+'Topology/'+region+'/b'+basin+'/intermediate/check_junctions.csv'
