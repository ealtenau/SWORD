...
cl_dir = main_dir+'/data/update_requests/v17/'+region+'/channel_additions/'+region.lower()+'_channel_additions2_v17_pts.gpkg'
outfile = main_dir+'/data/update_requests/v17/'+region+'/channel_additions/'+region.lower()+'_channel_additions2.nc'
