...
import os
main_dir = os.getcwd()
import updates.channel_additions.case_by_case.cl_additions_reach_def_tools as rdt
...
# Input file(s).
nc_file = main_dir+'/data/update_requests/v18/'+region+'/channel_additions/'\
    +region.lower()+'_channel_additions.nc'
sword_fn = main_dir+'/data/outputs/Reaches_Nodes/v18/netcdf/'+region.lower()+'_sword_v18.nc'
