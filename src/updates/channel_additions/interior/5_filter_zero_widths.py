...
(5_filter_zero_widths.py)
===================================================

This script flags MHV addition reaches in sword
...
Execution example (terminal):
    python path/to/5_filter_zero_widths.py NA v17
...
zero_down = np.where((n_rch_down == 0)&(category != 6))[0]
if len(zero_down) > 1:
    print('!!! Downstream Break in Additions !!!')
    print(reaches[zero_down])
    ...
    if min(flag) < 1:
        ...
        rch_csv.to_csv(outdir+'width_based_deletions.csv', index = False)
