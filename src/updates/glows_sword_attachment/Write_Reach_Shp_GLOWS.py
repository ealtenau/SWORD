...
reaches = gp.GeoDataFrame([
    ...
    np.array(data1.groups['reaches'].variables['glows_wth_med'][:]),
    np.array(data1.groups['reaches'].variables['glows_wth_min'][:]),
    np.array(data1.groups['reaches'].variables['glows_wth_max'][:]),
    np.array(data1.groups['reaches'].variables['glows_wth_1sig'][:]),
]).T
