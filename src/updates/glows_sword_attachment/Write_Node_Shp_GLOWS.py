...
nodes = gp.GeoDataFrame([
    ...
    np.array(data.groups['nodes'].variables['glows_wth_med'][:]),
    np.array(data.groups['nodes'].variables['glows_wth_min'][:]),
    np.array(data.groups['nodes'].variables['glows_wth_max'][:]),
    np.array(data.groups['nodes'].variables['glows_wth_1sig'][:]),
    np.array(data.groups['nodes'].variables['glows_river_id'][:]),
]).T
