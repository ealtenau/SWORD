...
for r in regions:
    start = time.time()
    print(r.upper())
    sword_fn = main_dir+'/data/outputs/Reaches_Nodes/v18/gpkg/'+r+'_sword_reaches_v18.gpkg'
    ...
    tile_csv.to_csv(main_dir+'/data/swot_data/SWORD_v18_PassTile/nominal/csv/'+r+'_sword_reaches_v18_pass_tile_nominal.csv', index=False)
    # tile_csv.to_csv(main_dir+'/data/swot_data/SWORD_v18_PassTile/calval/csv/'+r+'_sword_reaches_v18_pass_tile_calval.csv', index=False)

    reaches['pass_tile'] = rch_tiles
    outgpkg = main_dir+'/data/swot_data/SWORD_v18_PassTile/nominal/gpkg/'+r+'_sword_reaches_v18_pass_tile_nominal.gpkg'
    # outgpkg = main_dir+'/data/swot_data/SWORD_v18_PassTile/calval/gpkg/'+r+'_sword_reaches_v18_pass_tile_calval.gpkg'
...
csv_df.to_csv(main_dir+'/data/swot_data/SWORD_v18_PassTile/nominal/csv/Pass_Tile_Nominal_SWORD_v18_Region.csv', index=False)
# csv_df.to_csv(main_dir+'/data/swot_data/SWORD_v18_PassTile/calval/csv/Pass_Tile_CalVal_SWORD_v18_Region.csv', index=False)
