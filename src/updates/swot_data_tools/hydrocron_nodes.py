...
# subset2.to_csv(main_dir+'/data/swot_data/Sacramento_River/hydrocron_wse_nodes.csv',index=False)
...
# df_med.to_csv(main_dir+'/data/swot_data/Sacramento_River/hydrocron_wse_nodes_median.csv',index=False)
...
subset2 = pd.read_csv(main_dir+'/data/swot_data/Sacramento_River/hydrocron_wse_nodes.csv')
med_data = pd.read_csv(main_dir+'/data/swot_data/Sacramento_River/hydrocron_wse_nodes_median.csv')
riffles_df = gp.read_file(main_dir+'/data/swot_data/Sacramento_River/sac_riffle_pooles.gpkg')
