...
outdir = main_dir+'/data/inputs/GRWL/EDITS/'
grwl_dir = main_dir+'/data/inputs/GRWL/GRWL_Masks_V01.01_LatLonNames/'
grwl_paths = np.sort([file for file in getListOfFiles(grwl_dir) if '.tif' in file])
fn_cl = main_dir+'/data/inputs/GRWL_temp/EDITS/gpkg/global_cl_updates_Nov2022.gpkg'
