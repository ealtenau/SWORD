...
import os
main_dir = os.getcwd()
import src.development.reach_definition.Reach_Definition_Tools_v11 as rdt
import src.development.reach_definition.Write_Database_Files as wf
import time
import numpy as np
import argparse
...
# Input file(s).
nc_file = main_dir+'/data/outputs/Merged_Data/v12/'+region+'_Merge_v12.nc'

# Output files.
nc_outpath = main_dir+'/data/outputs/Reaches_Nodes/netcdf/'+region.lower()+'_sword_'+version+'.nc'
swot_outpath = main_dir+'/data/outputs/SWOT_Coverage/'+region.lower()+'_swot_obs_'+version+'.nc'
