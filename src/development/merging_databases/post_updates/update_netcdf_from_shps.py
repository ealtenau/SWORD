...
region = 'OC'
grwl_dir = main_dir+'/data/outputs/Merged_Data/v13/' + region + '/'
grwl_paths = [file for file in mgt.getListOfFiles(grwl_dir) if '.shp' in file]
nc_file = main_dir+'/data/outputs/Merged_Data/v13/' + region + '_Merge_v13.nc'
out_dir = main_dir+'/data/outputs/Merged_Data/v13/' + region + '/'
