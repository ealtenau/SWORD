...
class SWORDValidator:
    ...
    # =========================================================================
    def check_width_monotonicity(
        self, region: Optional[str] = None, threshold: float = 0.3
    ) -> ValidationResult:
        """
    ...
    # =========================================================================
    def check_path_freq_consistency(
        self, region: Optional[str] = None
    ) -> ValidationResult:
        """
    ...
    def print_report(self, results: Dict[str, ValidationResult]):
        ...
        for name, result in results.items():
            ...
            print(
                f"   Checked: {result.total_checked:,} | Issues: {result.issues_found:,} ({result.issue_pct:.2f}%)"
            )
