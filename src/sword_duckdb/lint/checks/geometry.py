...
def check_endpoint_alignment(
    ...
    This covers all connection types including confluences (n_rch_up >= 2)
    and bifurcations (n_rch_down >= 2).  Previously G019 and G020 checked
    those subsets separately but were strict subsets of this check and have
    been removed.
    """
...
# strict subsets of G012 (endpoint_alignment), which checks ALL downstream
# pairs with the same LEAST-of-4-distances pattern and 500m threshold.
