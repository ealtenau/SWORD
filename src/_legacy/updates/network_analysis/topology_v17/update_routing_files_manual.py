...
topo_dir = main_dir+'/data/outputs/Topology/'+region+'/b'+b+'/'

rrr_top_shp= topo_dir + region.lower()+'_sword_reaches_hb' + b + '_v17_FG1_LSFix_MS_TopoFix_Acc.shp'
rrr_con_csv= topo_dir + region.lower()+'_sword_reaches_hb' + b + '_v17_FG1_LSFix_MS_TopoFix_con.csv'
rrr_riv_csv= topo_dir + region.lower()+'_sword_reaches_hb' + b + '_v17_FG1_LSFix_MS_TopoFix_riv.csv'
