...
topo_dir = main_dir+'/data/outputs/Topology/'+version+'/'+region+'/'
gpkg_dir = main_dir+'/data/outputs/Reaches_Nodes/'+version+'/gpkg/'

rrr_con_csv= topo_dir + region.lower()+'_sword_reaches_'+version+'_routing_con.csv'
rrr_bas_csv= topo_dir + region.lower()+'_sword_reaches_'+version+'_routing_riv.csv'
rrr_acc_shp= topo_dir + region.lower()+'_sword_reaches_'+version+'_acc.gpkg'
rrr_rch_acc= topo_dir + region.lower()+'_sword_reaches_'+version+'_acc.csv'
rrr_top_shp= gpkg_dir + region.lower()+'_sword_reaches_'+version+'.gpkg'
...
shp['acc'] = results
shp.to_file(rrr_acc_shp, driver='GPKG', layer='routing')
