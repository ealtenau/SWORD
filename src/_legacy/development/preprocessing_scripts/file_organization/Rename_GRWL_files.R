...
#grwl_path = '/inputs/GRWL/GRWL_vector_V01.01/GRWL_vector_V01.01'

mask_files = list.files('/inputs/GRWL/masks/GRWL_mask_V01.01/', '.tif', full.names = TRUE)
...
grwl_files = list.files('/inputs/GRWL/GRWL_vector_V01.01/GRWL_vector_V01.01/', full.names = TRUE)
...
for(i in 1:length(mask_files)){
  ...
  mask_outpath = paste('/inputs/GRWL/masks/', 'GRWL_mask_V01.01_LatLonNames/', name, '.tif', sep = "")
  ...
  for(j in 1:length(fn_grwl)){
    ...
    grwl_outpath = paste('/inputs/GRWL/GRWL_vector_V01.01_LatLonNames/', name, ext, sep = "")
...
#outpath = '/inputs/GRWL/name_table.csv'
