...
grwl_paths = [file for file in getListOfFiles(main_dir+'/data/inputs/GRWL/GRWL_vector_V01.01_LatLonNames/') if '.shp' in file]
cont_file = main_dir+'/data/inputs/ArcFiles/continent.shp'
...
df.to_csv(main_dir+'/data/inputs/GRWL/GRWL_Tiles_Continents.csv')         
