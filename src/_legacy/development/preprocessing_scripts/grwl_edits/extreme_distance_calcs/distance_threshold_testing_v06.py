...
# define paths. 
fn_lakes = main_dir+'/data/inputs/lakes_near_rivers/shp/2367_dist_thresh_test.tif'
fn_nodes = main_dir+'/data/inputs/lakes_near_rivers/databases/na_sword_scene2367_wc1_v06.nc'
outpath = main_dir+'/data/inputs/lakes_near_rivers/s2367_dist_thresh_testing_extdvar.csv'
out_nc = main_dir+'/data/inputs/lakes_near_rivers/databases/na_sword_scene2367_wc1_extdvar_v06.nc'
