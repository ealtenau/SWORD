...
grwl_dir = main_dir+'/data/inputs/mask_buffer/'+region+'/'
fn_grwl = os.listdir(grwl_dir)
fn_lakes = main_dir+'/data/inputs/For_Server/inputs/LakeDatabase/UCLA/FixedGeometries/NA_UCLA_Lakes2015_SWOT_FixGeom.shp'
fn_sword = main_dir+'/data/outputs/Reaches_Nodes/netcdf/'+region.lower()+'_apriori_rivers_v10.nc'
outpath = main_dir+'/data/inputs/lakes_near_rivers/'+region.lower()+'_extdist_nodes.csv'
