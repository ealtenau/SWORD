PRO GRWL_Bank_Width_Calculation_v2
  ...
  shp_dir = '\inputs\GRWL\shps\GRWL_vector_V01.01_LatLonNames\' ;grwl shapefile directory.
  shp_files = file_search(shp_dir, '*.shp')
  shp_names = strmid(shp_files, 83, 7)

  grwl_dir = '\inputs\GRWL\masks\GRWL_mask_V01.01_LatLonNames\' ;grwl mask directory.
...
;    
    ...
    ;;;;;; 
    outpath = string('\inputs\GRWL\GRWL_Bank_Widths\',shp_names[ind],'_bw.csv') ;creating final outpath.
