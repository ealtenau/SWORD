...
grod_fn = main_dir+'/data/inputs/GROD/GROD_ALL.csv'
hf_fn = main_dir+'/data/inputs/HydroFalls/hydrofalls.csv'
outpath = main_dir+'/data/inputs/HydroFalls/hydrofalls_filt.csv'
