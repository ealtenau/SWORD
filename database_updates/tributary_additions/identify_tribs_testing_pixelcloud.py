...
pixc_dir = '/Users/ealteanau/Documents/SWORD_Dev/swot_data/tributary_additions_tests/'
...
for ind in list(range(0,1)):#len(pixc_files))):
    ...
    mhv_fn = '/Users/ealteanau/Documents/SWORD_Dev/inputs/MHV_SWORD/na_mhv_sword.nc'
