...
sword = nc.Dataset('/Users/ealtenau/Documents/SWORD_Dev/outputs/Reaches_Nodes/v16_glows/netcdf/'+region.lower()+'_sword_v16_glows.nc')
...
df.to_csv('/Users/ealtenau/Documents/SWORD_Dev/swot_data/glows_sword_calval_reaches/reach_csv_glows_s2validation/sword_glows_s2_validation_regions'+glows_rg+'.csv', index = False)
sword.close()
