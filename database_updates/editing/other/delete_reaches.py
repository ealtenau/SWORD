...
# rch_dir = '/Users/ealtenau/Documents/SWORD_Dev/update_requests/v17/AS/as_v17_single_pt_rchs2.csv'

# rm_rch_df = pd.read_csv(rch_dir)
# rm_rch = np.array(rm_rch_df['reach_id']) #csv file
# rm_rch = np.unique(rm_rch)
rm_rch = np.array([56391700055,56391700075,56395004575,56121000076,56121000025,56100100296,56100100093,56100100316,56100100141,56100100133,56220901001,56220901051,56233500376,56233500205,56233500235,56233500396,56233500195,56233500366,56233500356,56233500185,56233500416,56233500275,56233500285,56233500426,56233500295,56233500436,56233500446,56233500305,56233500406,56233500245,56233500316,56233500045,56233500025,56234000366,56239000455,56239000626,56253300196,56490400021,56510000065,56410700211,56410800131,56395000203,56395000121,56900100541,56873000181,56873000206,57108000613,57202000011]) #manual
rm_rch = np.unique(rm_rch)
