...
grwl_paths = getListOfFiles('C:/Users/ealtenau/Documents/Research/SWAG/GRWL/shps/GRWL_vector_V01.01_LatLonNames/')
cont_path = 'C:/Users/ealtenau/Documents/Research/SWAG/GRWL/EDITS/GRWL_Tiles_Continents.csv'
...
for ind in list(range(len(region))):
    ...
    for f in cp_files:    
        out_dir = 'C:/Users/ealtenau/Documents/Research/SWAG/For_Server/inputs/GRWL/' + region[ind] + '/' 
