PRO GRWL_Tile_Fixes_v03
  ...
  openw, 1, 'C:\Users\ealtenau\Documents\Research\SWAG\GRWL\GRWL_TileFix_Messages_031919.txt'
  ...
  for ind=378, 378 do begin ; to adjust range when error occurs
    tm2=systime(1)
