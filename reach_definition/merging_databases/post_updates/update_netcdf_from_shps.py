...
import os
os.chdir('C:/Users/ealtenau/Documents/Research/SWAG/For_Server/scripts/merging_databases/')
...
region = 'EU'
grwl_dir = 'F:/SWORD/Development_Files/outputs/Merged_Data_v10/' + region + '/'
grwl_paths = [file for file in mgt.getListOfFiles(grwl_dir) if '.shp' in file]
nc_file = '../../outputs/Merged_Data/' + region + '/' + region + '_Merge_v10.nc'
out_dir = '../../outputs/Merged_Data/' + region + '/' + region + '/'
