...
node_outpath = 'C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/Reaches_Nodes/shp/'+region+'/'+region.lower()+'_sword_nodes_'
...
for ind in list(range(len(uniq_level2))):
    ...
    node_outfile = node_outpath + 'hb' + str(uniq_level2[ind]) + version +'.shp'
