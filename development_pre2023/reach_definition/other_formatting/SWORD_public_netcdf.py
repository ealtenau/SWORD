# -*- coding: utf-8 -*-
"""
Created on Fri Mar 20 12:34:34 2020
...
def read_data(filename):
    ...
    nodes.dams = data.groups['nodes'].variables['obstr_type'][:]
    ...
    reaches.dams = data.groups['reaches'].variables['obstr_type'][:]
...
###############################################################################
region = 'OC'
fn = 'C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/Reaches_Nodes/netcdf/'+region.lower()+'_apriori_rivers_v10.nc'
outfile = 'E:/Users/Elizabeth Humphries/Documents/SWORD/Manuscript/SWORD_Version1/netcdf/'+region.lower()+'_sword_v1.nc'

# read originial data.
centerlines, nodes, reaches = read_data(fn)
# re-write netcdf.
write_database_nc(centerlines, reaches, nodes, region, outfile)
