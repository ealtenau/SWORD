PRO GRWL_Tile_Fixes_v04
  ...
  openw, 1, 'C:\Users\ealtenau\Documents\Research\SWAG\GRWL\GRWL_TileFix_Messages_031919.txt' ;text file that prints progress. 
  ...
  fix_path = 'C:\Users\ealtenau\Documents\Research\SWAG\GRWL\EDITS\GRWL_TileFixes_NA_GEE.csv' ;grwl edits directory.
  ...
  start_ind = 161 ;0 ;to run all rows this should be set to: 0.
  end_ind = 161 ;n_elements(mask_names)-1 ;to run all rows this should be set to: n_elements(mask_names)-1.
  plot_figs = 'True'
