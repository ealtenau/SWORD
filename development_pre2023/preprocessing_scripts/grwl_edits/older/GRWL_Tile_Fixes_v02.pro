...
openw, 1, 'C:\Users\ealtenau\Documents\Research\SWAG\GRWL\GRWL_TileFix_Messages_020919.txt'
...
fix_path = 'C:\Users\ealtenau\Documents\Research\SWAG\GRWL\GRWL_Fix_Test.csv'
...
for ind=0, n_elements(mask_names)-1 do begin
  tm2=systime(1)
  ...
  ;Creating new image to fill with new points. 
  fix_pts = img*0
  filler = img*0
  ...
  for rw=0, n_elements(rows)-1 do begin
    ...
    ;print, 'Row Number = ', rows[rw], systime(1)-tm 
    ...
    if flags[rows[rw]] gt 4 then begin
...
;    endfor
    ...
    fixes(add_to_output) = count
    ;fixes(where(cl_pts eq 1)) = count
    ;iimage, fixes, window_title = string(rows[rw])
  ...
  outpath = string('C:\Users\ealtenau\Documents\Research\SWAG\GRWL\masks\Mask_Edits\',mask_names[ind],'_edit.csv')
