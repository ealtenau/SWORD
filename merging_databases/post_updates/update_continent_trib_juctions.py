...
fn = 'C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/Merged_Data/OC/OC_Merge_v08.nc'
...
df.columns = ['lon', 'lat'] 
#df.to_csv('C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/test_merging/new_tribs.csv')
...
#df2.to_csv('C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/test_merging/old_id_hb81.csv')

df3 = pd.DataFrame(np.array([grwl.lon[l2], grwl.lat[l2], grwl.newID[l2], grwl.cl_id[l2]]).T)
df3.columns = ['lon', 'lat', 'id', 'ind'] 
#df3.to_csv('C:/Users/ealtenau/Documents/Research/SWAG/For_Server/outputs/test_merging/new_id_hb81.csv')
