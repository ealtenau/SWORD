...
sourceFile = open('/Users/ealteanau/Documents/SWORD_Dev/swot_data/temp_data/log_file.txt', 'w')
...
sword_dir = '/Users/ealteanau/Documents/SWORD_Dev/outputs/Reaches_Nodes/v16/netcdf/'
...
for basin in list(range(len(unq_l2))): 
    ...
    for ind in list(range(501,len(subset))):
        ...
        if len(os.listdir(folder)) == 0:
            ...
            sword_lon, sword_lat, sword_tribs = subset_sword(sword, pixc_lon, pixc_lat) #tfs.subset_sword(sword, pixc_lon, pixc_lat)

            #subset merrit hydro vector to tile extent.
            mhv_lon, mhv_lat, \
                mhv_flag, mhv_seg, \
                    mhv_dist, indexes = subset_mhv(mhv, pixc_lon, pixc_lat) #tfs.subset_mhv(mhv, pixc_lon, pixc_lat)
            ...
            plt.xlabel('x')
            plt.ylabel('y')
            plt.savefig('/Users/ealteanau/Documents/SWORD_Dev/testing_files/test_trib_add_plots/'+tiles[subset[ind]]+'.png')
            plt.close()
