...
def find_connections(centerlines):
    ...
    for ind in list(range(len(unq_rch))):
        ...
        if len(rch) < 10:
            ...
            # if len(n1) > 3:
            #     print('end 1 has more than 3 neighbors', unq_rch[ind], len(n1))
            # if len(n2) > 3:
            #     print('end 2 has more than 3 neighbors', unq_rch[ind], len(n2))
...
#find all neighbors.
centerlines.neighbors = find_connections(centerlines)
