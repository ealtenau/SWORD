...
import os
if os.path.exists('/Users/ealtenau/Documents/SWORD_Dev/src/SWORD/post_swot_launch_updates/sword_adjustments/'):
    os.chdir('/Users/ealtenau/Documents/SWORD_Dev/src/SWORD/post_swot_launch_updates/sword_adjustments/')
else:
