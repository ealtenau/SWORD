...
def read_cl_data(cl_dir):
    ...
    return cl_x, cl_y, cl_seg, cl_ind
...
cl_dir = '/Users/ealtenau/Documents/SWORD_Dev/update_requests/v17/channel_additions/'+region.lower()+'_channel_additions_points_ALL.gpkg'
outfile = '/Users/ealtenau/Documents/SWORD_Dev/update_requests/v17/channel_additions/'+region.lower()+'_channel_additions.nc'
...
eps = np.where(cl_eps[seg]>0)[0]
plt.scatter(cl_x[seg], cl_y[seg], s = 3, c=cl_ind[seg], cmap='rainbow')
plt.scatter(cl_x[seg[eps]], cl_y[seg[eps]], s = 5, c='black')
plt.show()
